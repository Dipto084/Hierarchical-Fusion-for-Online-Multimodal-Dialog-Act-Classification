...
class WhisperIntegratedModel(nn.Module):
    ...
    def __init__(self, whisper_model_name, dropout = 0.3, num_labels = 52):
    ...
    def forward(self, audio):
        whisper_model = WhisperModel.from_pretrained(self.whisper_model_name)
        feature_extractor = WhisperFeatureExtractor.from_pretrained(self.whisper_model_name)
