...
from baseline_model_2_multi_comb import Classifier
...
if __name__ == '__main__':
    ...
    for seed in seed_list:
        ...
        scheduler = ReduceLROnPlateau(optimizer, mode = 'max', patience = 20, factor = 0.1, verbose = True)
        ...
        try:
            ...
            for epoch in range(40):
                ...
                df.to_csv(f'./log_multi_comb_{seed}.csv')
                try:
                    os.mkdir(f'./classification_reports_multi_comb_{seed}')
                except:
                    pass

                with open(f'./classification_reports_multi_comb_{seed}/cr_{epoch}.txt', mode='w') as file:
                    file.write(cr)
