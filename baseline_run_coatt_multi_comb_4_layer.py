...
from baseline_model_coatt_multi_comb_4_layer import Classifier
...
if __name__ == '__main__':
    ...
    for seed in seed_list:
        ...
        try:
            os.mkdir(f'./prediction_out_self_multi_comb_4_layer_{seed}')
        except:
            pass
        ...
        try:
            ...
            for epoch in range(40):
                ...
                df.to_csv(f'./log_self_multi_comb_4_layer_{seed}.csv')
                try:
                    os.mkdir(f'./classification_reports_self_multi_comb_4_layer_{seed}')
                except:
                    pass

                with open(f'./classification_reports_self_multi_comb_4_layer_{seed}/cr_{epoch}.txt', mode='w') as file:
                    file.write(cr)
